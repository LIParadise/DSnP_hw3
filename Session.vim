...
set shortmess=aoO
badd +196 src/cmd/cmdParser.cpp
badd +87 src/cmd/cmdParser.h
...
silent! normal! zE
let s:l = 351 - ((13 * winheight(0) + 22) / 45)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 188 - ((9 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
188
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 69 - ((6 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
69
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 21 - ((4 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
21
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 27 - ((19 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
27
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 42 - ((32 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
42
